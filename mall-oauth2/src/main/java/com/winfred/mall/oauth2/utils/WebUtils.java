...
package com.winfred.mall.oauth2.utils;

import cn.hutool.core.codec.Base64;
import com.winfred.common.exception.MallDefaultException;
...
public class WebUtils extends org.springframework.web.util.WebUtils {
  ...
  public HttpServletResponse getResponse() {
    ServletRequestAttributes servletRequestAttributes = getServletRequestAttributes();
    if (servletRequestAttributes == null) {
      throw new MallDefaultException("无法获取HttpServletRequest");
    }
  ...
  private static String[] splitClient(String header) {
    if (header == null || !header.startsWith(BASIC_)) {
      throw new MallDefaultException("请求头中client信息为空");
    }
    ...
    try {
      ...
      throw new MallDefaultException("Failed to decode basic authentication token");
    }
    ...
    if (delim == -1) {
      throw new MallDefaultException("Invalid basic authentication token");
    }
